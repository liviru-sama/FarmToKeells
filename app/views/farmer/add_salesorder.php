        ...
        <section class="form">
            <div class="center"><br><br>
                ...
                <form style="padding:30px;"
                    action='<?php echo URLROOT; ?>/farmer/add_salesorder?purchase_id=<?php echo $data['purchase_id']; ?>'
                    method="post" id="myForm">
                    <input type="hidden" name="user_id"
                        value="<?php echo isset($_GET['user_id']) ? $_GET['user_id'] : ''; ?>">
                    <!-- Hidden input field to store the purchase ID -->
                    <input type="hidden" name="purchase_id"
                        value="<?php echo isset($data['purchase_id']) ? $data['purchase_id'] : ''; ?>">
                    ...
                    <div class="text-field">
                        <input name='name' id="productName" type="text"
                    ...
                    <div class="text-field">
                        ...
                        <input name="quantity" id="quantity" type="number" min="0" step="1" required
                            <?php echo isset($data['quantity']) ? 'max="'.$data['quantity'].'"' : ''; ?>>
