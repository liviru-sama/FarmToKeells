...
<img src="<?php echo URLROOT; ?>/public/images/farmer_dashboard/dash3.png" alt="Notifications" class="navbar-icon">
    ...
    <div class="main-content">
        ...
        <a href="<?php echo URLROOT; ?>/farmer/view_payment" style="text-decoration: none;">
            <h5 class="inline-heading" class="tab-heading tab-selected">&nbsp;&nbsp;&nbsp;View Your Payment Details</h5>
        </a>
                ...
                <form action="<?php echo URLROOT; ?>/farmer/handle_edit_payment" method="post">
                    <div class="text-field">
                        ...
                        <input type="text" id="bank_account_number" name="bank_account_number"
                            value="<?php echo $data['bank_account_number']; ?>"><br>
                    </div>
                    <div class="text-field">
                        <label for="account_name">Account Holder Name:</label><br>
                        <input type="text" id="account_name" name="account_name"
                            value="<?php echo $data['account_name']; ?>"><br>
                    </div>
                    <div class="text-field">
                        <div class="typeselect-container">
                            <select class="productstatusInput" name="bank" onchange="updateInput(this)">
                                <option style="color:white;" value=""
                                    <?php echo ($data['bank'] == '') ? 'selected' : ''; ?>></option>
                                <option style="color:white;" value="" disabled selected></option>
                                <!-- Empty option for placeholder -->
                                <option style="color:white;" value="Commercial Bank (COMB)">Commercial Bank (COMB)
                                </option>
                                ...
                                <option style="color:white;" value="Hatton National Bank (HNB)">Hatton National Bank
                                    (HNB)</option>
                                <option style="color:white;" value="National Development Bank (NDB)">National
                                    Development Bank (NDB)</option>
                                <option style="color:white;" value="Nations trust Bank (NTB)">Nations trust Bank (NTB)
                                </option>
