    ...
    <div class="main-content">
        ...
        <section class="form">
            <div class="center">
                ...
                <form
                    action="<?php echo URLROOT; ?>/farmer/edit_salesordercommon/<?php echo $data['order_id']; ?>&user_id=<?php echo $_SESSION['user_id']; ?>"
                    method="post">
                    ...
                    <div class="text-field">
                        ...
                        <input type="text" name="type" id="typeInput" value="<?php echo $data['type']; ?>"
