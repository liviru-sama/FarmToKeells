...
<div class="navbar-icon-container" data-text="Logout">
    ...
    <div class="main-content">
        ...
        <a href="<?php echo URLROOT; ?>/farmer/edit_salesordercommon" style="text-decoration: none;">
            <h5 class="inline-heading" class="tab-heading tab-selected" style="background: #65A534; transform: scale(1.08); border-radius: 10px 10px 10px 10px; padding: 10px;">&nbsp;&nbsp;&nbsp;Edit Order</h5>
        </a>
