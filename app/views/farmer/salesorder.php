...
<div style="position: relative; display: inline-block;">
    <img src="<?php echo $row->image; ?>" alt="<?php echo $row->name; ?>" class="card__image" style="border-radius:100px;">
        ...
        border-radius: 5px; padding: 5px; font-weight: bold; font-family: 'Inter', sans-serif;">
            <?php echo $row->status; ?>
                                    ...
                                    <a href="<?php echo URLROOT; ?>/farmer/edit_salesordercommon?id=<?php echo $row->order_id; ?>" <?php echo $row->status === 'Completed' ? 'class="disabled-link"' : ''; ?>><img src="<?php echo URLROOT; ?>/public/images/edit.png" class="card__action" data-text="Edit this order"></a>
                                        <a href="<?php echo URLROOT; ?>/farmer/place_order/<?php echo $row->order_id; ?>" class="<?php echo $row->status !== 'Approved' ? 'disabled-link' : ''; ?>"><img src="<?php echo URLROOT; ?>/public/images/transport.png" class="card__action <?php echo $row->status !== 'Approved' ? 'disabled-link' : ''; ?>" data-text="Request for payment"></a>
                                        <a href="<?php echo $row->status === 'Completed' ? URLROOT . '/farmer/payment' : '#'; ?>"><img src="<?php echo URLROOT; ?>/public/images/pay.png" class="card__action <?php echo $row->status !== 'Completed' ? 'disabled-link' : ''; ?>"></a>
