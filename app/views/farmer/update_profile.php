    ...
    <div class="card-white">
                    ...
                    <div class="subgrid-4">
                        ...
                        <div class="rectangle">
                            ...
                            <form action="<?php echo URLROOT;?>/farmer/update_profile/<?php echo $_SESSION['user_id'];?>" method="POST" class="subgrid-1">
                                <label for="nusername" class="p-regular-grey">New Name :</label>
                        ...
                        <div class="rectangle">
                            ...
                            <form action="<?php echo URLROOT;?>/farmer/update_profile/<?php echo $_SESSION['user_id'];?>" method="POST" class="subgrid-1">
                                <label for="nusername" class="p-regular-grey">New E-mail :</label>
                                <input type="text" id="new_name" name="new_name" class="form-default">
                                <button class="button-main" type="submit">Change</button>
                        ...
                        <div class="rectangle">
                            ...
                            <form action="<?php echo URLROOT;?>/farmer/update_profile/<?php echo $_SESSION['user_id'];?>" method="POST" class="subgrid-1">
                                <label for="nusername" class="p-regular-grey">New Mobile :</label>
                                <input type="text" id="new_name" name="new_name" class="form-default">
                                <button class="button-main" type="submit">Change</button>
