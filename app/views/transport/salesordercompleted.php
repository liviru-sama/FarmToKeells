...
<div class="navbar">
    ...
    <div class="main-content">
        <section class="header">
               ...
               <a href="<?php echo URLROOT; ?>/transport/salesorderapproved" style="text-decoration: none;">
    <h5 class="inline-heading"  >&nbsp;&nbsp;&nbsp; Approved</h5>
</a><a href="<?php echo URLROOT; ?>/transport/salesordercompleted" style="text-decoration: none;background: #65A534; transform: scale(1.08);">
    ...
    <div class="select-container">
        <select class="statusInput" name="<?php echo is_array($row) ? 'status[]' : $row->status; ?>" onchange="submitForm(this)" <?php echo (is_array($row) && isset($row['status']) && $row['status'] == 'Completed') ? ' 
 "' : ''; ?>>
